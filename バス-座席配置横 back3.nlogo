...
to move ;乗客の行動（乗車・座席立席位置探し）
  ...
  loop [
    ...
    if (count signs-on humans <= 14) ;適当に車内を移動
    ...
    if (count humans-on signs < 16 and count humans-on sign 5 = 1 and count humans-on sign 6 = 1 and count humans-on sign 7 = 1 and count humans-on sign 11 = 1 and count humans-on sign 12 = 1 and count humans-on sign 13 = 1)
